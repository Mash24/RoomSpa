...
export function WhatsAppFloat() {
  return (
    <WhatsAppLink
      ...
      className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition hover:scale-[1.03] hover:bg-[#20bd5b] sm:h-auto sm:w-auto sm:gap-2 sm:px-4 sm:py-3"
    >
