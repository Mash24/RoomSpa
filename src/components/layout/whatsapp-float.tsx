...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-medium text-white shadow-lg shadow-black/20 transition hover:scale-[1.02] hover:bg-[#20bd5b]"
    >
