...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-50 inline-flex min-h-12 min-w-12 items-center justify-center gap-2 rounded-full bg-[#25D366] px-3.5 py-3 text-sm font-medium text-white shadow-lg shadow-black/20 transition hover:scale-[1.02] hover:bg-[#20bd5b] xs:px-4"
    >
