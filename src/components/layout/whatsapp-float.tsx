...
export function WhatsAppFloat() {
  return (
    <WhatsAppLink
      ...
      className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(0.75rem,env(safe-area-inset-right))] z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition hover:scale-[1.03] hover:bg-[#20bd5b] xs:right-[max(1rem,env(safe-area-inset-right))] sm:bottom-[max(1.25rem,env(safe-area-inset-bottom))] sm:h-auto sm:w-auto sm:gap-2 sm:px-4 sm:py-3"
    >
